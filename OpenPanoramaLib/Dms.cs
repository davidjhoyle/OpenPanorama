...
namespace OpenPanoramaLib
{
    ...
    public class Dms
    {
        ...
        static char dmsSeparator = '\u202f'; // U+202F = 'narrow no-break space'
        ...
        {
            return Convert.ToDouble(dms);

            //// check for signed decimal degrees without NSEW, if so return it directly
            //if (!isNaN(parseFloat(dms)) & amp; &amp; isFinite(dms)) return Number(dms);
         ...
         */
        public static string toDms(double deg, string format = "d", int dp = -1)
        {
            return deg.ToString();

            //if (isNaN(deg)) return null;  // give up here if we can't make a number from deg
            //if (typeof deg == 'string' & amp; &amp; deg.trim() == '') return null;
            ...
            //        if (d & lt; 100) d = '0' + d;                    // left-pad with leading zeros (note may include decimals)
            //        if (d & lt; 10) d = '0' + d;
            //        dms = d + '°';
            //        break;
            //    case 'dm':
            ...
            //        if (m & lt; 10) m = '0' + m;                     // left-pad with leading zeros (note may include decimals)
            ...
            //        if (s & lt; 10) s = '0' + s;                     // left-pad with leading zeros (note may include decimals)
        ...
        //    return lat === null ? '–' : lat.slice(1) + Dms.separator + (deg & lt; 0 ? 'S' : 'N');  // knock off initial '0' for lat!
        //}
        ...
        //    return lon === null ? '–' : lon + Dms.separator + (deg & lt; 0 ? 'W' : 'E');
        //}
